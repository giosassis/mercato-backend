...
urlpatterns = [
    ...
    path('sales/<uuid:sale_id>/items/', SaleItemViewSet.as_view({'get': 'list', 'post': 'create'}), name='sale-items'),
    path('sales/items/<uuid:pk>/', SaleItemViewSet.as_view({'delete': 'destroy'}), name='delete-sale-item'),
]